...
public class SendMail {
	...
	private String to = PropertyMgr.getMailTo();

	private String from = PropertyMgr.getMailFrom();

	private String host = PropertyMgr.getMailHost();

	private String username = PropertyMgr.getMailUser();

	private String password = PropertyMgr.getMailPass();
	...
	public void send(File file) throws Exception {
		Log.debug("SendMail file[" + file + "] to " + to);
